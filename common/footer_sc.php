            ...
            <div class="col-lg-4 col-md-12" data-purpose="footer-column-contact">
                ...
                <div class="contact-info-container">
                    <div class="contact-info-item">
                        ...
                        <span>651 N Broad St, Suite 201, Middletown, Zip Code 19709, New Castle, Delaware, USA.</span>
                    </div>
                    <div class="contact-info-item">
                ...
                <div class="social-icons-wrapper">
                    <a aria-label="Facebook" class="social-icon-btn" href="#"><i class="fa-brands fa-facebook-f"></i></a>
                    <a aria-label="X (Twitter)" class="social-icon-btn" href="#"><i class="fa-brands fa-x-twitter"></i></a>
                    <a aria-label="Instagram" class="social-icon-btn" href="#"><i class="fa-brands fa-instagram"></i></a>
                    <a aria-label="LinkedIn" class="social-icon-btn" href="#"><i class="fa-brands fa-linkedin-in"></i></a>
