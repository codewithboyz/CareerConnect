        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu custom-dropdown border-0 shadow-sm-lg">
              <li><a href="screen\employee\job_screen.php">Browse Jobs</a></li>
          ...
          <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL ?>screen/admin/Contactus.php">Contact Us</a></li>
