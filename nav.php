...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link
      href="Asset/bootstrap-5.3.7-dist/css/bootstrap.min.css"
      rel="stylesheet"
    />
        ...
        >
          <ul class="navbar-nav mx-auto">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-dropdown="home"
                >Home</a
              >
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-dropdown="jobs"
                >Jobs</a
              >
              <ul class="dropdown-menu custom-dropdown">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-dropdown="blog"
                >Blog</a
              >
              <ul class="dropdown-menu custom-dropdown">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-dropdown="pages"
                >Pages</a
              >
              <ul class="dropdown-menu custom-dropdown">
          ...
          <div class="nav-buttons d-flex align-items-center">
            ...
            <img
              src="Asset/Image/testimonials-4.jpg"
