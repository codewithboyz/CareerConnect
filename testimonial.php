                ...
                <div class="marquee-track" id="sliderTrack">
                    ...
                    <div class="testimonial-card card border-0 shadow-sm p-4">
                        ...
                        <p class="text-muted flex-grow-1">
                            "JobsPortal helped me land my dream role within weeks. The process was clean, seamless, and
                    ...
                    <div class="testimonial-card card border-0 shadow-sm p-4">
                        <i class="fa-solid fa-quote-left text-primary fs-3 mb-3"></i>
                        <p class="text-muted flex-grow-1">
                            "As an employer, we found top talent faster than ever before. The platform makes publishing
                    ...
                    <div class="testimonial-card card border-0 shadow-sm p-4">
                        <i class="fa-solid fa-quote-left text-primary fs-3 mb-3"></i>
                        <p class="text-muted flex-grow-1">
                            "We scaled our hiring pipeline dramatically thanks to JobsPortal's reach and user-friendly
                            tools."
                        </p>
                        <div class="d-flex align-items-center gap-3 mt-4">
