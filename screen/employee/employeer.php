...
<head>
    ...
    <title>Career Connect | Employer</title>
            ...
            <div class="row justify-content-center justify-content-lg-center">
                <div class="col-xl-9 col-lg-10">
                    ...
                    <div class="text-center text-lg-start">
                        ...
                        <h1 class="hero-title mb-3">Find companies that align with your values</h1>

                        <p class="hero-subtitle mx-auto mx-lg-0">
                            Browse company profiles, read about their culture, and connect with employers actively
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-12 col-lg-5">
                                <div class="input-group search-input-group input-primary-border overflow-hidden">
                                    ...
                                    <input type="text" class="form-control ps-2" placeholder="Company name or keyword">
                                </div>
                            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <h3 class="fw-bold mb-0">38 companies Found</h3>
                                        ...
                                        <div class="col-12">
                                            <div
                                                ...
                                                <div class="card-body p-2">
                                                    ...
                                                    <div
                                                        class="input-group custom-input-group mb-4 rounded-3 overflow-hidden">
                                                        <span class="input-group-text text-primary pe-3">
                                                            <i class="fa-solid fa-industry"></i>
                                                        </span>
                                                        <input type="text" class="form-control ps-2 py-2"
                    ...
                    <div class="card p-4 mb-4 shadow-sm rounded-4 jobcards_hover">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-2" style="max-width:600px;">
                                        A multidisciplinary studio building immersive product experiences for finance,
                                        ecommerce, and emerging tech brands. We combine research-led design with
                                        battle-tested engineering to launch products that scale.
                                    </p>
                                    <!-- TAGS -->
                            ...
                            <!-- RIGHT SIDE -->
                            <div
                                class="ps-4 border-start d-flex flex-column justify-content-between align-items-center btn-groups">
                                <!-- bookmark -->
