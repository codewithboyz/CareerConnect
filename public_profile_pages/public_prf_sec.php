  ...
  <div class="card rounded-5 border-0 shadow-sm p-3">
    <div class="card-body">
      ...
      <div class="d-flex flex-column flex-md-row gap-3">
        <button type="button" class="btn btn-outline-primary"><i class="fa-solid fa-link"></i> Copy Link</button>
        <a href="#" class="btn btn-primary "><i class="fa-solid fa-eye"></i> View live profile</a>
      </div>
    </div>
  </div>
  ...
  <div class="card border-0 shadow-sm rounded-5 p-4 mb-4">
    <div class="d-flex flex-column flex-md-row gap-4 align-items-md-center">
      ...
      <div class="flex-shrink-0 text-center text-md-start">
        <img src="https://sharjeelanjum.com/html/jobs-portal/images/candidates/01.jpg" alt="Job Seeker" class="rounded-4 object-fit-cover shadow-sm" style="width: 120px; height: 120px;">
      </div>
      ...
      <div class="flex-grow-1">
        ...
        <p class="text-secondary mb-3 fs-6">
          Lead Product Designer &middot; Remote friendly &middot; Currently shipping fintech experiences with Skyline Digital.
        </p>
    ...
    <div class="d-flex flex-column">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <div>
          ...
          <p class="text-muted">Allow verified recruiters to discover you in search results.</p>
        </div>
        <div class="d-flex">
    ...
    <div class="d-flex flex-column">
      ...
      <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
        ...
        <div class="d-flex gap-2">
          <a href="editprofile.php" type="button" class="btn btn-outline-primary btn-sm rounded-3 px-2 fw-medium">Edit</a>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
        ...
        <div class="d-flex gap-2">
          <a href="editprofile.php" type="button" class="btn btn-outline-primary btn-sm rounded-3 px-2 fw-medium">Manage</a>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between align-items-center py-2">
        ...
        <div class="d-flex gap-2">
          <a href="editprofile.php" type="button" class="btn btn-outline-secondary btn-sm rounded-3 px-2 fw-medium">Add</a>
        </div>
      </div>
